      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-12 max-w-7xl mx-auto">
          ...
          <div className="flex flex-col space-y-4 font-inter text-sm text-secondary-fixed-dim">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex flex-col gap-1 leading-relaxed">
                <span>+58 414-4436607</span>
                <span>+58 412-8642585</span>
                <span>+58 416-0110479</span>
              </div>
            </div>
            <div className="flex items-start gap-3">
        ...
        <div className="flex flex-col xl:items-end">
          ...
          <div className="flex items-center gap-4">
            {/* Instagram */}
            <a className="w-10 h-10 rounded-full bg-secondary-fixed/10 flex items-center justify-center text-secondary-fixed-dim hover:text-on-secondary hover:bg-secondary-fixed/30 hover:-translate-y-1 transition-all duration-300 shadow-sm" href="https://www.instagram.com/rotonac_tanques/" target="_blank" rel="noopener noreferrer" title="Instagram">
            ...
            {/* WhatsApp */}
            <a className="w-10 h-10 rounded-full bg-secondary-fixed/10 flex items-center justify-center text-secondary-fixed-dim hover:text-on-secondary hover:bg-secondary-fixed/30 hover:-translate-y-1 transition-all duration-300 shadow-sm" href="https://wa.me/584144436607?text=Hola,%20vengo%20de%20la%20p%C3%A1gina%20web,%20necesito%20m%C3%A1s%20informaci%C3%B3n%20acerca%20de%20los%20productos%20que%20venden." target="_blank" rel="noopener noreferrer" title="WhatsApp">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
